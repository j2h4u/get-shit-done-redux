...
- **手动 canary 发布工作流** — `.github/workflows/canary.yml` 通过 `workflow_dispatch` 从 `dev` 分支按需将 `{base}-canary.{N}` 构建（`get-shit-done-redux` 与 `@gsd-redux/sdk`）发布到 `@canary` dist-tag。
...
```bash
# Claude Code
npx get-shit-done-redux --claude --global   # 安装到 ~/.claude/
npx get-shit-done-redux --claude --local    # 安装到 ./.claude/

# OpenCode
npx get-shit-done-redux --opencode --global # 安装到 ~/.config/opencode/

# Gemini CLI
npx get-shit-done-redux --gemini --global   # 安装到 ~/.gemini/

# Kilo
npx get-shit-done-redux --kilo --global     # 安装到 ~/.config/kilo/
npx get-shit-done-redux --kilo --local      # 安装到 ./.kilo/

# Codex
npx get-shit-done-redux --codex --global    # 安装到 ~/.codex/
npx get-shit-done-redux --codex --local     # 安装到 ./.codex/

# Copilot
npx get-shit-done-redux --copilot --global  # 安装到 ~/.github/
npx get-shit-done-redux --copilot --local   # 安装到 ./.github/

# Cursor CLI
npx get-shit-done-redux --cursor --global   # 安装到 ~/.cursor/
npx get-shit-done-redux --cursor --local    # 安装到 ./.cursor/

# Antigravity
npx get-shit-done-redux --antigravity --global # 安装到 ~/.gemini/antigravity/
npx get-shit-done-redux --antigravity --local  # 安装到 ./.agent/

# Augment
npx get-shit-done-redux --augment --global     # 安装到 ~/.augment/
npx get-shit-done-redux --augment --local      # 安装到 ./.augment/

# Trae
npx get-shit-done-redux --trae --global     # 安装到 ~/.trae/
npx get-shit-done-redux --trae --local      # 安装到 ./.trae/

# CodeBuddy
npx get-shit-done-redux --codebuddy --global # 安装到 ~/.codebuddy/
npx get-shit-done-redux --codebuddy --local  # 安装到 ./.codebuddy/

# Cline
npx get-shit-done-redux --cline --global       # 安装到 ~/.cline/
npx get-shit-done-redux --cline --local        # 安装到 ./.clinerules

# 所有运行时
npx get-shit-done-redux --all --global      # 安装到所有目录
```
...
**命令行为不符合预期？**
- 运行 `/gsd-help` 确认安装成功
- 重新执行 `npx get-shit-done-redux` 进行重装
...
```bash
# 全局安装
npx get-shit-done-redux --claude --global --uninstall
npx get-shit-done-redux --opencode --global --uninstall
npx get-shit-done-redux --gemini --global --uninstall
npx get-shit-done-redux --kilo --global --uninstall
npx get-shit-done-redux --codex --global --uninstall
npx get-shit-done-redux --copilot --global --uninstall
npx get-shit-done-redux --cursor --global --uninstall
npx get-shit-done-redux --antigravity --global --uninstall
npx get-shit-done-redux --augment --global --uninstall
npx get-shit-done-redux --trae --global --uninstall
npx get-shit-done-redux --cline --global --uninstall

# 本地安装（当前项目）
npx get-shit-done-redux --claude --local --uninstall
npx get-shit-done-redux --opencode --local --uninstall
npx get-shit-done-redux --gemini --local --uninstall
npx get-shit-done-redux --kilo --local --uninstall
npx get-shit-done-redux --codex --local --uninstall
npx get-shit-done-redux --copilot --local --uninstall
npx get-shit-done-redux --cursor --local --uninstall
npx get-shit-done-redux --antigravity --local --uninstall
npx get-shit-done-redux --augment --local --uninstall
npx get-shit-done-redux --trae --local --uninstall
npx get-shit-done-redux --cline --local --uninstall
```
...
OpenCode、Gemini CLI、Kilo 和 Codex 现在都已经通过 `npx get-shit-done-redux` 获得原生支持。

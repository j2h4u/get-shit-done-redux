...
- **수동 카나리 릴리스 워크플로** — `.github/workflows/canary.yml`이 `workflow_dispatch`로 `dev` 브랜치에서 `{base}-canary.{N}` 빌드를 `@canary` dist-tag로 수동 게시(`get-shit-done-redux`와 `@gsd-redux/sdk`).
...
```bash
# Claude Code
npx get-shit-done-redux --claude --global   # ~/.claude/에 설치
npx get-shit-done-redux --claude --local    # ./.claude/에 설치

# OpenCode
npx get-shit-done-redux --opencode --global # ~/.config/opencode/에 설치

# Gemini CLI
npx get-shit-done-redux --gemini --global   # ~/.gemini/에 설치

# Kilo
npx get-shit-done-redux --kilo --global     # ~/.config/kilo/에 설치
npx get-shit-done-redux --kilo --local      # ./.kilo/에 설치

# Codex
npx get-shit-done-redux --codex --global    # ~/.codex/에 설치
npx get-shit-done-redux --codex --local     # ./.codex/에 설치

# Copilot
npx get-shit-done-redux --copilot --global  # ~/.github/에 설치
npx get-shit-done-redux --copilot --local   # ./.github/에 설치

# Cursor CLI
npx get-shit-done-redux --cursor --global      # ~/.cursor/에 설치
npx get-shit-done-redux --cursor --local       # ./.cursor/에 설치

# Antigravity
npx get-shit-done-redux --antigravity --global # ~/.gemini/antigravity/에 설치
npx get-shit-done-redux --antigravity --local  # ./.agent/에 설치

# Augment
npx get-shit-done-redux --augment --global     # ~/.augment/에 설치
npx get-shit-done-redux --augment --local      # ./.augment/에 설치

# Trae
npx get-shit-done-redux --trae --global        # ~/.trae/에 설치
npx get-shit-done-redux --trae --local         # ./.trae/에 설치

# Cline
npx get-shit-done-redux --cline --global       # ~/.cline/에 설치
npx get-shit-done-redux --cline --local        # ./.clinerules에 설치

# 전체 런타임
npx get-shit-done-redux --all --global      # 모든 디렉터리에 설치
```
...
- `npx get-shit-done-redux`를 다시 실행해 재설치
...
OpenCode, Gemini CLI, Kilo, Codex는 이제 `npx get-shit-done-redux`를 통해 기본 지원됩니다.

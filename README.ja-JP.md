...
完全なリストは [v1.39.0 リリースノート](https://github.com/GSD-redux/get-shit-done-redux/releases/tag/v1.39.0) を参照してください。
...
- **手動カナリアリリースワークフロー** — `.github/workflows/canary.yml` が `workflow_dispatch` 経由で `dev` ブランチから `{base}-canary.{N}` ビルドを `@canary` dist-tag に手動公開（`get-shit-done-redux` と `@gsd-redux/sdk`）。
...
```bash
# Claude Code
npx get-shit-done-redux --claude --global   # ~/.claude/ にインストール
npx get-shit-done-redux --claude --local    # ./.claude/ にインストール

# OpenCode
npx get-shit-done-redux --opencode --global # ~/.config/opencode/ にインストール

# Gemini CLI
npx get-shit-done-redux --gemini --global   # ~/.gemini/ にインストール

# Kilo
npx get-shit-done-redux --kilo --global     # ~/.config/kilo/ にインストール
npx get-shit-done-redux --kilo --local      # ./.kilo/ にインストール

# Codex
npx get-shit-done-redux --codex --global    # ~/.codex/ にインストール
npx get-shit-done-redux --codex --local     # ./.codex/ にインストール

# Copilot
npx get-shit-done-redux --copilot --global  # ~/.github/ にインストール
npx get-shit-done-redux --copilot --local   # ./.github/ にインストール

# Cursor CLI
npx get-shit-done-redux --cursor --global      # ~/.cursor/ にインストール
npx get-shit-done-redux --cursor --local       # ./.cursor/ にインストール

# Antigravity
npx get-shit-done-redux --antigravity --global # ~/.gemini/antigravity/ にインストール
npx get-shit-done-redux --antigravity --local  # ./.agent/ にインストール

# Augment
npx get-shit-done-redux --augment --global     # ~/.augment/ にインストール
npx get-shit-done-redux --augment --local      # ./.augment/ にインストール

# Trae
npx get-shit-done-redux --trae --global        # ~/.trae/ にインストール
npx get-shit-done-redux --trae --local         # ./.trae/ にインストール

# Cline
npx get-shit-done-redux --cline --global       # ~/.cline/ にインストール
npx get-shit-done-redux --cline --local        # ./.clinerules にインストール

# 全ランタイム
npx get-shit-done-redux --all --global      # すべてのディレクトリにインストール
```
...
- `npx get-shit-done-redux` を再実行して再インストールしてください
...
OpenCode、Gemini CLI、Kilo、Codexは `npx get-shit-done-redux` でネイティブサポートされています。
